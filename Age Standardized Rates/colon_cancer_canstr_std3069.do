...
log using "Log files\Age Standardization\colon_cancer_canstr_std3069", replace

**  GENERAL DO-FILE COMMENTS
**  program:		colon_cancer_canstr_std3069.do
**  project:      	Caribbean Cancer mortality trends 
**  author:       	Rocke&Sobers \ 26-AUG-2016 \ revised 14-OCT-2018
**  task1:          create age-standardised colon cancer rates for adults 30-69
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Colorectum\Colon_data3069_`x'.xls", replace firstrow(variables)	
		keep if sex==3
	gen year10 = year/10
	...
	** Graph --> Adjusted Colorectum Cancer mortality rate for 21 Caribbean countries (women and men)
#delimit ;
	graph twoway 	
		/// Lowess smoother Colorectum
		...
		lab(1 "Smoothed Colorectum rate") 
		lab(2 "Poisson model Colorectum")
		);
		
#delimit cr

graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Colorectum\graph_Colon_`x'.gph", replace
