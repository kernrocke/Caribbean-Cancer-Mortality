...
log using "Log files\Age Standardization\breast_cancer_canstr_std3069", replace
...
**  task1:          create age-standardised Breast cancer rates for adults 30-69
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Breast\Breast_data3069_`x'.xls", replace firstrow(variables)	
		keep if sex==1
	gen year10 = year/10
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Breast\graph_Breast_`x'.gph", replace
