...
**  task1:          create age-standardised lung cancer rates
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Lung\Lung_data30_`x'.xls", replace firstrow(variables)	
		keep if sex==3
	gen year10 = year/10
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Lung\graph_Lung_`x'.gph", replace
