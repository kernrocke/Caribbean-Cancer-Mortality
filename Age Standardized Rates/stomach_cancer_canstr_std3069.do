...
log using "Log files\Age Standardization\stomach_cancer_canstr_std30", replace

**  GENERAL DO-FILE COMMENTS
**  program:		stomach_cancer_canstr_std3069.do
**  project:      	Caribbean Cancer mortality trends 
**  author:       	Rocke&Sobers \ 26-AUG-2016 \ revised 14-OCT-2018
**  task1:          create age-standardised stomach cancer rates for adults 30-69
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Stomach\Stomach_data3069_`x'.xls", replace firstrow(variables)	
		keep if sex==3
	gen year10 = year/10
	...
	** Graph --> Adjusted Stomach Cancer mortality rate for 21 Caribbean countries (women and men)
#delimit ;
	graph twoway 	
		/// Lowess smoother Stomach
		...
		lab(1 "Smoothed Stomach rate") 
		lab(2 "Poisson model Stomach")
		);
		
#delimit cr

graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Stomach\graph_Stomach_`x'.gph", replace
