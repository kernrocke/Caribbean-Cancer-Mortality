...
log using "Log files\Age Standardization\prostate_cancer_canstr_std30", replace

**  GENERAL DO-FILE COMMENTS
**  program:		prostate_cancer_canstr_std30.do
**  project:      	Caribbean Cancer mortality trends 
**  author:       	Rocke&Sobers \ 26-AUG-2016 \ revised 14-OCT-2018
**  task1:          create age-standardised prostate cancer rates
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Prostate\Prostate_data30_`x'.xls", replace firstrow(variables)	
		keep if sex==2
	gen year10 = year/10
...
#delimit ;
	graph twoway 	
	    ...
	    ylab(20(20)300, axis(1) labs(3) nogrid glc(gs12) angle(0) format(%9.0f))
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Prostate\graph_Prostate_`x'.gph", replace
