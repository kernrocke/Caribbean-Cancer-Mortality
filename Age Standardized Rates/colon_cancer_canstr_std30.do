...
log using "Log files\Age Standardization\colon_cancer_canstr_std30", replace

**  GENERAL DO-FILE COMMENTS
**  program:		colon_cancer_canstr_std30.do
**  project:      	Caribbean Cancer mortality trends 
**  author:       	Rocke&Sobers \ 26-AUG-2016 \ revised 14-OCT-2018
**  task1:          create age-standardised colon cancer rates 
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Colorectum\Colon_data30_`x'.xls", replace firstrow(variables)	
		keep if sex==3
	gen year10 = year/10
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Colorectum\graph_Colon_`x'.gph", replace
