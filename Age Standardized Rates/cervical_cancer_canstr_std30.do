...
log using "Log files\Age Standardization\cervical_cancer_canstr_std30", replace
...
**  task1:          create age-standardised cervical cancer rates
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Cervical\Cervical_data30_`x'.xls", replace firstrow(variables)	
		keep if sex==1
	gen year10 = year/10
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_30\Cervical\graph_Cervical_`x'.gph", replace
