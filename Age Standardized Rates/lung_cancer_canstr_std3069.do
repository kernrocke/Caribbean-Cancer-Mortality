...
log using "Log files\Age Standardization\lung_cancer_canstr_std30", replace

**  GENERAL DO-FILE COMMENTS
**  program:		lung_cancer_canstr_std30.do
**  project:      	Caribbean Cancer mortality trends 
**  author:       	Rocke&Sobers \ 26-AUG-2016 \ revised 14-OCT-2018
**  task1:          create age-standardised lung cancer rates for adults 30-69
...
*In this section I am creating a loop for the creation of graphs
	...
	export excel using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Lung\Lung_data3069_`x'.xls", replace firstrow(variables)	
		keep if sex==3
	gen year10 = year/10
	...
	** Graph --> Adjusted Lung Cancer mortality rate for 21 Caribbean countries (women and men)
#delimit ;
	graph twoway 	
		/// Lowess smoother Lung
		...
		lab(1 "Smoothed Lung rate") 
		lab(2 "Poisson model Lung")
		);
		
#delimit cr

graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Mortality Rates\Standardized_3069\Lung\graph_Lung_`x'.gph", replace
