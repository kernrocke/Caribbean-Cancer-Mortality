...
log using "Log files\Trend Graphs\prostate_cancer_canstr_std30", replace


**  GENERAL DO-FILE COMMENTS
**  program:		prostate_cancerstr_std30.do
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop2.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(prostate_agestd3i_30.dta, replace) 

use "prostate_agestd3i_30.dta", clear
