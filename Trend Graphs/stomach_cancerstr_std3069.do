****This file produces data for stomach cancer both, male and female sex cats
...
log using "Log files\Trend Graphs\stomach_cancer_canstr_std30", replace


**  GENERAL DO-FILE COMMENTS
**  program:		stomach_cancerstr_std3069.do
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop3.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(stomach_agestd3i_3069.dta, replace) 

use "stomach_agestd3i_3069.dta", clear
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop3.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(stomach_agestd1s_3069.dta, replace) 

use "stomach_agestd1s_3069.dta", clear
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop3.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(stomach_agestd2s_3069.dta, replace) 

use "stomach_agestd2s_3069.dta", clear



/// Graphs of Stomach Cancer Mortalitiy for men and women
...
#delimit ;
	graph twoway 
		...
		(line pred2 year if cod==16, clw(0.25) clc(green*0.5) clp("l") )
		,*/
	    ...
	    ytitle("Stomach Cancer Rate (per 100,000)", axis(1) size(3) margin(r=3)) 
		ytick(0(5)50)
		ymtick(0(5)50)
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Graphs\stomach_trend_str_3069",replace
