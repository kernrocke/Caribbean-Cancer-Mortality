...
**  program:		stomach_cancerstr_std30.do
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop2.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(stomach_agestd3i_30.dta, replace) 

use "stomach_agestd3i_30.dta", clear
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop2.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(stomach_agestd1s_30.dta, replace) 

use "stomach_agestd1s_30.dta", clear
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop2.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(stomach_agestd2s_30.dta, replace) 

use "stomach_agestd2s_30.dta", clear
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Graphs\stomach_trend_str_30",replace
