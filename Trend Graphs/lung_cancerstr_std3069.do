...
log using "Log files\Trend Graphs\lung_cancer_canstr_std3069", replace


**  GENERAL DO-FILE COMMENTS
**  program:		lung_cancerstr_std3069.do
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop3.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(lung_agestd3i_3069.dta, replace) 

use "lung_agestd3i_3069.dta", clear
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop3.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(lung_agestd1s_3069.dta, replace) 

use "lung_agestd1s_3069.dta", clear
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop3.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(lung_agestd2s_3069.dta, replace) 

use "lung_agestd2s_3069.dta", clear
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Graphs\lung_trend_str_3069",replace
