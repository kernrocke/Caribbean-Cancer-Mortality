...
log using "Log files\Trend Graphs\breast_cancer_canstr_std30", replace


**  GENERAL DO-FILE COMMENTS
**  program:		breast_cancerstr_std30.do
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Graphs\breast_trend_str_30",replace
