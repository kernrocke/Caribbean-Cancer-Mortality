****This file produces data for breast cancer 
...
log using "Log files\Trend Graphs\breast_cancer_canstr_std3069", replace


**  GENERAL DO-FILE COMMENTS
**  program:		breast_cancerstr_std3069.do
...
distrate deaths pop2 using "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Data\Population Numbers\world_pop3.dta" ,stand(age5) popstand(pop_std) by(year cid) mult(100000) format(%8.2f) saving(breast_agestd3i_3069.dta, replace) 

use "breast_agestd3i_3069.dta", clear
...
#delimit ;
	graph twoway 
		...
		(line pred2 year if cod==50, clw(0.25) clc(green*0.5) clp("l") )
		,*/
	    ...
	    ytitle("Breast Cancer Rate (per 100,000)", axis(1) size(3) margin(r=3)) 
		ytick(0(5)50)
		ymtick(0(5)50)
...
graph save Graph "G:\Statistical Data Anlaysis\2018\Cancer Mortality Trends\Graphs\breast_trend_str_3069",replace",replace
